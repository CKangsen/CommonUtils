...
public class EncryptUtils {
    ...
    public static final String TAG = EncryptUtils.class.getCanonicalName();
    private static final String AES_KEY = "Ov6fKFZDHY99iDpQSnG4TUrbi+wrrzwX3Tv2MZ7Uh7w=";//do not modify
    private static final int TIMES = 5;


    public static String encrypt(String salt, String psw) {
     ...
     *解密
     **/
    public static String decryptText(String encryptedPwd) {
        try {
     ...
     *加密
     **/
    public static String encryptText(String needEncryptWord,String alias) {
        try {
            DESKeySpec keySpec = new DESKeySpec(
     ...
     *解密
     **/
    public static String decryptText(String needDecryptWord,String alias) {
        try {
    ...
    public static String getAesKeyForRequestBody(String url, String salt){
     ...
     * @return
     */
    public static String encryptRequestBody(String content, String password) {
        try {
     ...
     * @return
     */
    public static String decryptRequestBody(String content, String password) {
        try {
            byte[] bytes1,bytes2,bytes3;
            bytes1 = password.getBytes("utf-8");
            int length = bytes1.length;
